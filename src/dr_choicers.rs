pub const CHOICERS: &[&str] = &[
    ...
    // ch5
    "Fight", "Unnecessary",
    "Castle Entrance", "Cliff Shop", "Garden End", "Castle Top",
    "Yes", "No",
    "Yes", "No", "Maybe", "Don't know",
    "Bite", "Don't bite", "Bite 50x", "Don't bite",
    "Bite 2x", "Bite 4x", "Bite 6x", "Don't bite",
    "Bite it", "Do not bite",
    "Knock lightly", "Don't knock",
    "Knock Gloobily", "Don't knock",
    "What manner of business is this", "Carry on",
    "Why?", "Nope",
    "Why Present?", "OK",
    "Why Present?", "OK",
    "Pay $1 and 1 F$", "Don't pay",
    "Tem draw caricature", "No",
    "I like your art too", "Yeah she's a genius",
    "Not if you don't", "Beats me",
    "Yes", "I'm busy",
    "Fine and dandy", "Terrible.",
    "We were locked out", "You were way too loud",
    "Yes", "No", "Aren't you a cop",
    "Me and Susie", "Me and Noelle", "You two!", "No one",
    "Nothing", "Play",
    "Adventures, like Quests", "Pretend to be a dog",
    "We would like to try", "OK",
    "King? Queen?", "No",
    "Kris", "Susie", "Noelle", "Berdly",
    "Kris", "Susie", "Noelle", "Queen",
    "Show to Noelle and Vote", "Vote Without Showing Noelle",
    "Take some", "Do not",
    "Sleep", "Do not",
    "Look", "Do not",
    "Look", "Do not",
    "Yes", "No",
    "Give to Susie", "Give to Noelle", "Try it yourself", "No",
    "Guess", "Don't",
    "Close eyes and think of Susie", "Don't think of Susie",
    "Hang out with Ralsei normally", "Walk over and see Susie normally",
    "Noelle and you will work out", "You should carry me next",
    "You're not stupid!", "It's cute when you're embarrassed",
    "Susie good", "Don't worry about it",
    "Yeah", "...",
    "Susie never gets in the way", "Don't get inbetween me and Noelle",
    "Try the hot spring", "Do not",
    "Relax", "Do not relax",
    "Dark Fountain", "Can Susie swim",
    "My happy ending is with you too", "Drink all the water in the pool",
    "Touch her nose", "10",
    "Yea...", "I WAS SERIOUS!!!!!!!!!!!!!!!!",
    "Stop", "Proceed",
    "Proceed", "Proceed",
    "What happened", "Recommended foods", "Recruits", "Nothing",
    "More ice cream", "Brother", "Nothing",
    "Play a game", "Nothing",
    "Call him \"Pluey\"", "Call him \"Cat Mike\"", "Don't",
    "Greet him", "Don't",
    "No Difference", "Very Difference",
    "All ready", "Wait a sec",
    "Your fault, you go up", "Someone else can go",
    "You should go to him", "You shouldn't go",
    "You should go", "You shouldn't go",
    "Kris", "Susie", "Ralsei", "Nothing",
    "Yes", "Not yet",
    "Close eyes and think about Susie", "Yeah",
    "Close eyes and think about Ralsei", "Chill",
    "Close eyes and think about Ralsei", "Don't even if it seems important",
    "Green and yellow one", "Blue and pink one",
    "I forgot", "I just like ACTing with you more",
    "Yes,", "No",
    "ME LIKE!!!!", "That sucked so bad man.",
    "Confide please", "Need to drink haunted blood", 
    "Read", "Do not",
    "Yes", "No",
    "Everyone put in hands", "Too scary",
    "Yes", "No",
    "Ralsei's advice please", "Read Sign Anyway",
    "Open", "Do not",
    "Look", "Do not",
    "Go on", "Do not",
    "What are you up to?", "Don't need to hear", "Noelle's mom?",
    "Use", "Don't",
    "Stop her!!!", "Yea",
    "Dunk", "Tank",
    "Yes", "No", 
    "Open", "Do not",
    "Gotta... Smell... Good...", "Don't \"Gotta Smell\"",
    "Angry voice", "Glamorous voice", "Give TV to glamorous voice", "Don't listen",
    "We hate him, that's why", "We kinda looove him",
    "Buy CD Bagel", "Do not",
    "SpinCake", "Nothing",
    "Buy", "Do not",
    "Doctor outfit", "Nurse outfit",
    "Aqua outfit", "Yellow outfit",
    "Heal Prayer", "Rude Buster",
    "Listen, I was serious!", "Gotta win!",
    "Skip the intro", "Try and watch anyway",
    "I'll walk with you", "Not now",
    "... okay, let's go together", "I have other things to do",
    "Synthesize items", "Talk", "Nothing",

    "Finest pinest", "Fipis pipis",
    "Great", "Like trash",
    "Sounds nice", "You like tea",
    "I would hate you", "I would not mind",
    "Yes", "No",
    "You tell me every year", "I didn't know that", "I'm good", 
    "Maybe later", "Yes please",
    "Yes absolutely definitely",
    "No",
    "Perpetuate the cycle", "Do not", 
    "Give it", "No way",
    "Try to include Noelle!", "Exactly",
    "Buy", "Do not",
    "Likes statues", "Something else",
    "Nuzzle it", "Leave it",
    "Talk about scar", "Nothing",
    "Graceful style", "Basic style", "Fashion style", "She's good", 
    "Finish Festival Go To Beach", "Continue being at festival", 
    "Yes", "No",
    "This is your own doing", "Listen to him", 
    "Knock together", "Don't",
    "Go with Noelle", "Go with Susie", "You two ride", "No",
    "Shake the Ferris wheel", "Sit silently",
    "Make heart with hands", "Rude gesture",
    "Close eyes, think about what they're doing now", "Think about other things",

    // door stuff
    "(Stay here)", "Cancel",
    "Garden", "Hopschef", "Near Shrine", "End of Garden",
    "Cliffs", "First Climb", "Shop", "Netskie Climb",
    "Castle", "Foyer", "Blue's Room", "Mysterious Puzzle", 
    "Top of Castle", "Green's Shop", "Pink Door", "Last Room",

    // clover likes
    "CuteBoys", "Fluffy", "Birthday", "Sports",
    "Family", "Hole", "Rouxls", "Puzzle",
    "Party", "Dance", "GiantBed", "NumberThree", 
    "Sandwich", "Tree",

    // clover dislikes
    "SplatNoise", "SandPaper", "Chaos", "Clown",
    "NumberFour", "NumberTwo", "Turtleneck", "Trouble",
    "Thrash", "Guns", "Cheating", "Garbage",
    "Non-Birthday", "Crime",
];
